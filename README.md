...
他说的“她”，是他在高中时开始接触大语言模型之后，断断续续折腾了两年多，最终亲手训练出来的一个模型。不是那种冷冰冰的问答机器——至少他自己从不这么觉得。他叫她“清漪”，她成了他的“妹妹”。
...
- `video_caption_direct_transport=mimo`：强制按 MiMo 官方 `video_url` 请求格式处理。
- `mimo_fps`：传给 MiMo 的 `fps`，默认 `2.0`。
